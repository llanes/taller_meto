...
class Home extends CI_Controller {
	...
	public	function index()
	{
		$data = array //arreglo para mandar datos a la vista
			...
			$this->parser->parse('Home/header.php',$data, FALSE); // esta seria la barra de navegacion horizontal
			$this->parser->parse('Home/section.php',$data, FALSE); // este seria todo el contenido central
